...
async function migrateInvestments(dbManager) {
...
async function migrateWatchlist(dbManager) {
  ...
  try {
    ...
    const watchlistItems = JSON.parse(stored);
...
async function migrateWallets(dbManager) {
...
async function migrateWalletAssets(dbManager, walletId, assets) {
...
export function showLocalStorageData() {
